...
class SeminarCostUnitReport extends Component {
  componentWillMount() {
...
SeminarCostUnitReport.propTypes = {
...
const mapStateToProps = state => (
  {
    costUnits: state.reportReducers.seminarCostUnits,
    dateRange: state.reportReducers.seminarCostUnitSearch.dateRange,
    loading: state.reportReducers.seminarCostUnitSearch.loading,
  }
);
...
const mapDispatchToProps = dispatch => (
  {
    fetchCostUnits: () => {
      dispatch({
        type: 'FETCH_SEMINAR_COST_UNITS_LOGIC',
      });
    },
    dateRangeChanged: value => (
      dispatch({
        type: 'SEMINAR_COST_UNIT_DATE_RANGE_CHANGED',
        payload: value,
      })
    ),
  }
...
const SeminarCostUnitReportWrapper = connect(
  mapStateToProps,
  mapDispatchToProps,
)(SeminarCostUnitReport);

export default SeminarCostUnitReportWrapper;
